    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-indigo-500 scrollbar-track-gray-100 hover:scrollbar-thumb-indigo-600">
            <div className="flex items-center justify-between mb-6">
